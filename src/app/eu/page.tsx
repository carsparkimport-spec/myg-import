  ...
  return (
    <Layout mainClassName="bg-[#0d0d0d] text-white">
      ...
      >
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-r from-black/90 via-black/55 to-black/10 opacity-[0.25]" />
        <div className="relative z-10 w-full max-w-[900px] px-7 py-16 sm:px-10 md:px-16 lg:px-[7vw]">
