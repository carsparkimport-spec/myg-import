...
export default function EuHomeCopyE5SWod3UCopyYbYH3_aW() {
  return (
    <div className="eu-page" id="top">
      <Header />
      <main>
        <section className="eu-hero">
           <div className="eu-hero-image eu-hero-image-summer" style={{ backgroundImage: 'url("/__mockup/images/eu-home-q8-front-hero.png")' }} />
          <div className="eu-hero-shade" />
           ...
           <div className="eu-hero-vehicle-tag" aria-label="Exemple de véhicule recherché">
             <span className="eu-hero-vehicle-dot" />
             <div><small>Opportunité trouvée en Europe</small><strong>Véhicule sélectionné selon vos critères</strong></div>
           </div>
        </section>
