...
const vehicles = [
  { image: "car-1.jpeg", make: "BYD", model: "Atto 3", year: "2024", mileage: "28 400", price: "27 990" },
  { image: "car-2.png", make: "BYD", model: "Seal", year: "2024", mileage: "19 600", price: "31 900" },
  { image: "car-3.png", make: "BYD", model: "Seal U DM-i", year: "2025", mileage: "15 000", price: "33 490" },
];
...
export default function EuHomeCopyE5SWod3UCopy2q5XUNrJ() {
  return (
      ...
      <main>
        <section className="eu-hero">
          ...
          <div className="eu-hero-copy">
              ...
              <p>Nous recherchons pour vous une voiture fiable et adaptée à votre quotidien parmi les stocks disponibles partout en Europe, selon vos critères et votre budget.</p>
             <div className="eu-hero-buttons"><a href="#contact" className="eu-button">Lancer ma recherche</a><a href="#process" className="eu-button eu-button-ghost">Découvrir notre méthode</a></div>
              <div className="eu-brand-note" style={{ marginTop: 34, paddingLeft: 15, borderLeft: "2px solid #dc2626", display: "grid", gap: 5, color: "#bdbdbd", fontSize: 12, letterSpacing: ".08em", textTransform: "uppercase" }}><span>Des recherches de 10 000 à 40 000 €</span><b style={{ color: "#fff", fontSize: 12, letterSpacing: ".04em", fontWeight: 600, textTransform: "none" }}>Dacia · Renault · Toyota · BYD · BMW · Mercedes · Hyundai</b></div>
          </div>
        </section>
          ...
          <div className="eu-section-inner">
            ...
            <div className="eu-feature-grid">{features.map(([icon, title, desc]) => <article className="eu-feature" key={title}><span>{icon}</span><h3>{title}</h3><p>{desc}</p></article>)}</div>
             <h2 className="eu-stock-heading" id="stock">Quelques opportunités trouvées en Europe</h2>
              <p className="eu-stock-intro" style={{ maxWidth: 680, color: "#999", fontSize: 15, margin: "0 0 25px" }}>Des citadines accessibles aux SUV et berlines mieux équipés, nous adaptons la recherche à votre budget. Ces exemples illustrent les opportunités disponibles en Europe et évoluent chaque jour.</p>
