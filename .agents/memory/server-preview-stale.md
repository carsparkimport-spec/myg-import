...
**How to apply:** En cas de divergence, vérifier d’abord le HTML SSR avec une requête directe vers le domaine de développement. Si le HTML est correct mais le cadre reste ancien, traiter le problème comme un cache ou une hydratation du Preview plutôt que réécrire le composant.